import type { CreateUpdateProjectDto, GetProjectListDto, ProjectDto } from './models';
...
export class ProjectService {
  ...
  getFiteredProjectList = (input: GetProjectListDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PagedResultDto<ProjectDto>>({
      method: 'GET',
      url: '/api/app/project/fitered-project-list',
